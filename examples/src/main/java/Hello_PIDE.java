...
public class Hello_PIDE {
  ...
  public static void main(String args[]) {
    Environment env = JSetup.makeEnvironment(Paths.get(System.getenv("/usr/local/isabisac")), 
      JPlatform.guess(), new Version("2015"));
    Configuration config = Configuration.fromPath(Paths.get("."), "libisabelle_Isac");
